...
public class DirectionsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mParam1 = getArguments().getString(ARG_PARAM1);
        View inf = inflater.inflate(R.layout.fragment_directions, container, false);
        TextView text = (TextView) inf.findViewById(R.id.textView);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof DirectionsFragment.OnFragmentInteractionListener) {
            mListener = (DirectionsFragment.OnFragmentInteractionListener) context;
        } else {
