...
public class FavoritesFragment extends Fragment {
    ...
    private SelectionFragment.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mParam1 = getArguments().getString(ARG_PARAM1);
        View inf = inflater.inflate(R.layout.fragment_selection, container, false);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof SelectionFragment.OnFragmentInteractionListener) {
            mListener = (SelectionFragment.OnFragmentInteractionListener) context;
        } else {
